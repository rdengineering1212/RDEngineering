    ...
    return (
      <textarea
        className={cn(
          ...
          "dark:bg-white/5 dark:text-white dark:border-border/40 dark:placeholder:text-slate-500",
          "dark:focus-visible:ring-secondary/60 dark:focus-visible:border-secondary/60 dark:hover:border-border/60",
          className
        )}
        ref={ref}
        {...props}
